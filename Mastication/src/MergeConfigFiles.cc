...
static CartesianVector gFile1LeftAnkleExtensorMidPoint;
...
static CartesianVector gFile1LeftAnkleFlexorMidPoint;
...
static CartesianVector gFile1RightAnkleExtensorMidPoint;
...
static CartesianVector gFile1RightAnkleFlexorMidPoint;
...
static CartesianVector gFile2LeftAnkleExtensorMidPoint;
...
static CartesianVector gFile2LeftAnkleFlexorMidPoint;
...
static CartesianVector gFile2RightAnkleExtensorMidPoint;
...
static CartesianVector gFile2RightAnkleFlexorMidPoint;
...
static CartesianVector gFile3LeftAnkleExtensorMidPoint;
...
static CartesianVector gFile3LeftAnkleFlexorMidPoint;
...
static CartesianVector gFile3RightAnkleExtensorMidPoint;
...
static CartesianVector gFile3RightAnkleFlexorMidPoint;
...
int main(int argc, char ** argv)
{
  ...
  file.RetrieveParameter("kLeftAnkleExtensorMidPoint", 3, gFile1LeftAnkleExtensorMidPoint);
  ...
  file.RetrieveParameter("kLeftAnkleFlexorMidPoint", 3, gFile1LeftAnkleFlexorMidPoint);
  ...
  file.RetrieveParameter("kRightAnkleExtensorMidPoint", 3, gFile1RightAnkleExtensorMidPoint);
  ...
  file.RetrieveParameter("kRightAnkleFlexorMidPoint", 3, gFile1RightAnkleFlexorMidPoint);
  ...
  file.RetrieveParameter("kLeftAnkleExtensorMidPoint", 3, gFile2LeftAnkleExtensorMidPoint);
  ...
  file.RetrieveParameter("kLeftAnkleFlexorMidPoint", 3, gFile2LeftAnkleFlexorMidPoint);
  ...
  file.RetrieveParameter("kRightAnkleExtensorMidPoint", 3, gFile2RightAnkleExtensorMidPoint);
  ...
  file.RetrieveParameter("kRightAnkleFlexorMidPoint", 3, gFile2RightAnkleFlexorMidPoint);
  ...
  Merge(gFile1LeftAnkleExtensorMidPoint, gFile2LeftAnkleExtensorMidPoint, 3, proportionFile2, gFile3LeftAnkleExtensorMidPoint);
  ...
  Merge(gFile1LeftAnkleFlexorMidPoint, gFile2LeftAnkleFlexorMidPoint, 3, proportionFile2, gFile3LeftAnkleFlexorMidPoint);
  ...
  Merge(gFile1RightAnkleExtensorMidPoint, gFile2RightAnkleExtensorMidPoint, 3, proportionFile2, gFile3RightAnkleExtensorMidPoint);
  ...
  Merge(gFile1RightAnkleFlexorMidPoint, gFile2RightAnkleFlexorMidPoint, 3, proportionFile2, gFile3RightAnkleFlexorMidPoint);
  ...
  file.WriteParameter("kLeftAnkleExtensorMidPoint", 3, gFile3LeftAnkleExtensorMidPoint);
  ...
  file.WriteParameter("kLeftAnkleFlexorMidPoint", 3, gFile3LeftAnkleFlexorMidPoint);
  ...
  file.WriteParameter("kRightAnkleExtensorMidPoint", 3, gFile3RightAnkleExtensorMidPoint);
  ...
  file.WriteParameter("kRightAnkleFlexorMidPoint", 3, gFile3RightAnkleFlexorMidPoint);

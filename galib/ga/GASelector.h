// $Header: /home/wis/Unix/cvsroot/galib/ga/GASelector.h,v 1.1.1.1 2001/05/11 16:00:09 ws Exp $
/* ----------------------------------------------------------------------------
  selector.h
  mbwall 10aug94
...
---------------------------------------------------------------------------- */
class GASelectionScheme:public GAID { public:
	...
	} virtual void update() {} virtual GAGenome & select() const = 0;
...
class GARankSelector:public GASelectionScheme { public:
...
class GARouletteWheelSelector:public GASelectionScheme { public:
...
class GATournamentSelector:public GARouletteWheelSelector { public:
...
class GAUniformSelector:public GASelectionScheme { public:
...
class GASRSSelector:public GASelectionScheme { public:
...
class GADSSelector:public GASelectionScheme { public:

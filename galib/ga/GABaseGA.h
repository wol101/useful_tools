// $Header: /home/wis/Unix/cvsroot/galib/ga/GABaseGA.h,v 1.1.1.1 2001/05/11 16:00:08 ws Exp $
/* ----------------------------------------------------------------------------
  gabase.h
  mbwall 28jul94
...
---------------------------------------------------------------------------- */
class GAGeneticAlgorithm:public GAID { public:
	...
	GAGenome::AsexualCrossover asexual()const { return across;
		...
		} void flushScores() { if (stats.flushFrequency() > 0)
			stats.flushScores();

// $Header: /home/wis/Unix/cvsroot/galib/ga/gaerror.h,v 1.1.1.1 2001/05/11 16:00:06 ws Exp $
/* ----------------------------------------------------------------------------
  error.h
  mbwall 7may95
...
void GAErr(const GASourceLocator loc,
	   const char *function_name, GAErrorIndex i, const char *msg2 = 0, const char *msg3 = 0);

// $Header: /home/wis/Unix/cvsroot/galib/ga/GAScaling.h,v 1.1.1.1 2001/05/11 16:00:06 ws Exp $
/* ----------------------------------------------------------------------------
  scaling.h
  mbwall 10aug94
...
---------------------------------------------------------------------------- */
class GAScalingScheme:public GAID { public:
...
class GASigmaTruncationScaling:public GAScalingScheme { public:
...
class GAPowerLawScaling:public GAScalingScheme { public:
...
---------------------------------------------------------------------------- */
#if USE_SHARING == 1
class GASharing:public GAScalingScheme { public:

// $Header: /home/wis/Unix/cvsroot/galib/ga/GA3DBinStrGenome.h,v 1.1.1.1 2001/05/11 16:00:10 ws Exp $
/* ----------------------------------------------------------------------------
  binstr3.h
  mbwall 19apr95
...
-------------------------------------------------------------------------------
---------------------------------------------------------------------------- */
class GA3DBinaryStringGenome:public GABinaryString, public GAGenome { public:
...
// specific to this class
	...
	{ return bit(z * ny * nx + y * nx + x);
		...
		_evaluated = gaFalse;
		return ((bit(z * ny * nx + y * nx + x) == value) ? value :

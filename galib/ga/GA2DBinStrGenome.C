// $Header: /home/wis/Unix/cvsroot/galib/ga/GA2DBinStrGenome.C,v 1.1.1.1 2001/05/11 16:00:10 ws Exp $
/* ----------------------------------------------------------------------------
  binstr2.C
  mbwall 19apr95
...
GABinaryString(width * height), GAGenome(DEFAULT_2DBINSTR_INITIALIZER,
					 DEFAULT_2DBINSTR_MUTATOR, DEFAULT_2DBINSTR_COMPARATOR)
{
	evaluator(f);
	userData(u);
...
GA2DBinaryStringGenome::GA2DBinaryStringGenome(const GA2DBinaryStringGenome &
...
#ifndef NO_STREAMS
int GA2DBinaryStringGenome::read(istream & is)
{
	static char c;
...
int GA2DBinaryStringGenome::write(ostream & os) const
{
...
int
	GA2DBinaryStringGenome::UniformCrossover(const GAGenome & p1,
						 const GAGenome & p2, GAGenome * c1, GAGenome * c2)
{
	...
	} else if (c1 || c2)
	{
		GA2DBinaryStringGenome & sis = (c1 ?
						DYN_CAST(GA2DBinaryStringGenome &,
							 *c1) :
...
int
	GA2DBinaryStringGenome::OnePointCrossover(const GAGenome & p1,
						  const GAGenome & p2, GAGenome * c1, GAGenome * c2)
{
	const GA2DBinaryStringGenome & mom = DYN_CAST(const GA2DBinaryStringGenome &, p1);
	const GA2DBinaryStringGenome & dad = DYN_CAST(const GA2DBinaryStringGenome &, p2);
...
int
	GA2DBinaryStringGenome::EvenOddCrossover(const GAGenome & p1,
						 const GAGenome & p2, GAGenome * c1, GAGenome * c2)
{
	const GA2DBinaryStringGenome & mom = DYN_CAST(const GA2DBinaryStringGenome &, p1);
	const GA2DBinaryStringGenome & dad = DYN_CAST(const GA2DBinaryStringGenome &, p2);

// $Header: /home/wis/Unix/cvsroot/galib/ga/GATreeBASE.C,v 1.1.1.1 2001/05/11 16:00:07 ws Exp $
/* ----------------------------------------------------------------------------
  treebase.C
  mbwall 25nov94
...
int GATreeIterBASE::size(GANodeBASE * n)
{
...
int GATreeIterBASE::depth(GANodeBASE * n)
{

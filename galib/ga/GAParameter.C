// $Header: /home/wis/Unix/cvsroot/galib/ga/GAParameter.C,v 1.1.1.1 2001/05/11 16:00:10 ws Exp $
/* ----------------------------------------------------------------------------
  parameters.C
  mbwall 28jul94
...
int GAParameterList::write(ostream & os) const
{
	for (unsigned int i = 0; i < n; i++)
	{
		int ival;
...
int GAParameterList::read(istream & is, GABoolean flag)
{
	int nfound = 0;
	if (n == 0)
		return nfound;

// $Header: /home/wis/Unix/cvsroot/galib/ga/GAList.h,v 1.1.1.1 2001/05/11 16:00:09 ws Exp $
/* ----------------------------------------------------------------------------
  listtmpl.h
  mbwall 25feb95
...
// methods that modify the state of the list
	...
	int insert(GAList < T > *t, GAListBASE::Location where = GAListBASE::AFTER) {
		if (this == t)
		{
		 ...
		 {
		 delete c; return GAListBASE::ERR;}
		 iter.node = c; return GAListBASE::NO_ERR;}
...
// of the list.
      ...
      protected:
		 ...
		 return GAListBASE::ERR; iter.node = n; return GAListBASE::NO_ERR;}
...
---------------------------------------------------------------------------- */
template < class T > class GAList; template < class T > class GAListIter:public GAListIterBASE
		 {
      public:

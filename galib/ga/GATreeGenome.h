// $Header: /home/wis/Unix/cvsroot/galib/ga/GATreeGenome.h,v 1.1.1.1 2001/05/11 16:00:05 ws Exp $
/* ----------------------------------------------------------------------------
  tree.h
  mbwall 25feb95
...
// do our own here so that we can set/unset the _evaluated flag appropriately.
	...
	int destroy() { _evaluated = gaFalse;
		return GATree < T >::destroy();
	} int swaptree(GATree < T > *t) { _evaluated = gaFalse;

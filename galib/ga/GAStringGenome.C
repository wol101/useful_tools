// $Header: /home/wis/Unix/cvsroot/galib/ga/GAStringGenome.C,v 1.1.1.1 2001/05/11 16:00:04 ws Exp $
/* ----------------------------------------------------------------------------
  string.C
  mbwall 21mar95
...
GA1DArrayAlleleGenome < char >::GA1DArrayAlleleGenome(unsigned int length,
						      ...
						      void *u):GA1DArrayGenome < char >(length, f,
											u)
{
	naset = 1;
...
GA1DArrayAlleleGenome <
	char >::GA1DArrayAlleleGenome(const GAAlleleSetArray < char >&sa,
				      GAGenome::Evaluator f,
				      void *u):GA1DArrayGenome < char >(sa.size(), f, u)
{
	naset = sa.size();
...
int GA1DArrayAlleleGenome < char >::read(istream & is)
{
	unsigned int i = 0;
	char c;
	do
...
int GA1DArrayAlleleGenome < char >::write(ostream & os) const
{

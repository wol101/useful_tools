// $Header: /home/wis/Unix/cvsroot/galib/ga/GA1DBinStrGenome.C,v 1.1.1.1 2001/05/11 16:00:10 ws Exp $
/* ----------------------------------------------------------------------------
  binstr1.C
  mbwall 19apr95
...
GABinaryString(len), GAGenome(DEFAULT_1DBINSTR_INITIALIZER,
			      DEFAULT_1DBINSTR_MUTATOR, DEFAULT_1DBINSTR_COMPARATOR)
{
	evaluator(f);
	userData(u);
...
GA1DBinaryStringGenome::GA1DBinaryStringGenome(const GA1DBinaryStringGenome &
...
int GA1DBinaryStringGenome::read(istream & is)
{
	static char c;
	unsigned int i = 0;
...
int GA1DBinaryStringGenome::write(ostream & os) const
{
...
int
	GA1DBinaryStringGenome::equal(const GA1DBinaryStringGenome & c,
...
int
	GA1DBinaryStringGenome::UniformCrossover(const GAGenome & p1,
						 const GAGenome & p2, GAGenome * c1, GAGenome * c2)
{
	...
	} else if (c1 || c2)
	{
		GA1DBinaryStringGenome & sis = (c1 ?
						DYN_CAST(GA1DBinaryStringGenome &,
							 *c1) :
...
int
	GA1DBinaryStringGenome::OnePointCrossover(const GAGenome & p1,
						  const GAGenome & p2, GAGenome * c1, GAGenome * c2)
{
	const GA1DBinaryStringGenome & mom = DYN_CAST(const GA1DBinaryStringGenome &, p1);
	const GA1DBinaryStringGenome & dad = DYN_CAST(const GA1DBinaryStringGenome &, p2);
...
int
	GA1DBinaryStringGenome::TwoPointCrossover(const GAGenome & p1,
						  const GAGenome & p2, GAGenome * c1, GAGenome * c2)
{
	const GA1DBinaryStringGenome & mom = DYN_CAST(const GA1DBinaryStringGenome &, p1);
	const GA1DBinaryStringGenome & dad = DYN_CAST(const GA1DBinaryStringGenome &, p2);
...
int
	GA1DBinaryStringGenome::EvenOddCrossover(const GAGenome & p1,
						 const GAGenome & p2, GAGenome * c1, GAGenome * c2)
{
	const GA1DBinaryStringGenome & mom = DYN_CAST(const GA1DBinaryStringGenome &, p1);
	const GA1DBinaryStringGenome & dad = DYN_CAST(const GA1DBinaryStringGenome &, p2);

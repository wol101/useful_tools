// $Header: /home/wis/Unix/cvsroot/galib/ga/GASStateGA.h,v 1.1.1.1 2001/05/11 16:00:08 ws Exp $
/* ----------------------------------------------------------------------------
  gasteadystate.h
  mbwall 28jul94
...
class GASteadyStateGA:public GAGeneticAlgorithm {
	...
	} virtual GAScalingScheme & scaling(const GAScalingScheme & s) {	/* tmpPop->scaling(s); */
		return GAGeneticAlgorithm::scaling(s);
	} virtual GASelectionScheme & selector() const { return pop->selector();
	} virtual GASelectionScheme & selector(const GASelectionScheme & s) {	/* tmpPop->selector(s); */

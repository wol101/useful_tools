...
CompositeGenome::CompositeGenome(int element, int bond,
GABin2DecPhenotype & p, GAGenome::Evaluator f, void *u):
...
int
	CompositeGenome::CompositeCrossover(const GAGenome & a, const GAGenome & b,

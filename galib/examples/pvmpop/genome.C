...
int SendPopulation(int toid, const GAPopulation & pop)
{
	int status = 0;
	int psize = pop.size();
...
int RecvPopulation(GAPopulation & pop)
{
	int status = 0;
	int psize = 0;
...
int SendStatistics(int toid, const GAStatistics & s)
{
	int status = 0;
...
int RecvStatistics(GAStatistics & s)
{
	int status = 0;
	unsigned long int val;

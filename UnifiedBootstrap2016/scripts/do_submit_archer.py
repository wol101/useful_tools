...
usageString = usageString + "Options:\n" + \
    ...
    "    --nCoresPerNode n  The number of cores per node (24 normal or 48 for hyperhtreading)\n" + \
...
nHours = 0
nMinutes = 0
nCoresPerNode = 48 # current recommended value for Archer
...
executable = "/home/b16/b16/wisb16/work/UnifiedBootstrapAsync2016"
...
if hyperthreading:
    f += 'aprun -n %d -j 2 %s --repeats %d --serverArgs -d 0 --clientArgs -q\n' % (nCores, executable, nRepeats)
else:
...
logfile_name = time.strftime("Submit_Log_%Y-%m-%d_%H.%M.%S.txt", current_time)

...
class XMLConverterGA
{
public:
    XMLConverterGA();
    XMLConverterGA(XMLConverterGA &converter);
    ~XMLConverterGA();
...
protected:
    ...
    void NewCyclicDriver(xmlNodePtr parent, const char *target,
                         int n, double *d, double *v,
                         double phase = 0);
    void NewStepDriver(xmlNodePtr parent, const char *target,
                         int n, double *d, double *v);
    ...
    vector<ExpressionParserGA *> m_SmartSubstitutionParserComponents;

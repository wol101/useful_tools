...
SEG_PARAM_EXTERN double kTorsoGraphicScale;
//SEG_PARAM_EXTERN double kTorsoGraphicScale[3];
//SEG_PARAM_EXTERN double kTorsoGraphicOffset[3];
...
SEG_PARAM_EXTERN double kLeftThighGraphicScale;
//SEG_PARAM_EXTERN double kLeftThighGraphicScale[3];
//SEG_PARAM_EXTERN double kLeftThighGraphicOffset[3];
...
SEG_PARAM_EXTERN double kRightThighGraphicScale;
//SEG_PARAM_EXTERN double kRightThighGraphicScale[3];
//SEG_PARAM_EXTERN double kRightThighGraphicOffset[3];
...
SEG_PARAM_EXTERN double kLeftLegGraphicScale;
//SEG_PARAM_EXTERN double kLeftLegGraphicScale[3];
//SEG_PARAM_EXTERN double kLeftLegGraphicOffset[3];
...
SEG_PARAM_EXTERN double kRightLegGraphicScale;
//SEG_PARAM_EXTERN double kRightLegGraphicScale[3];
//SEG_PARAM_EXTERN double kRightLegGraphicOffset[3];
...
SEG_PARAM_EXTERN double kLeftFootGraphicScale;
//SEG_PARAM_EXTERN double kLeftFootGraphicScale[3];
//SEG_PARAM_EXTERN double kLeftFootGraphicOffset[3];
...
SEG_PARAM_EXTERN double kRightFootGraphicScale;
//SEG_PARAM_EXTERN double kRightFootGraphicScale[3];
//SEG_PARAM_EXTERN double kRightFootGraphicOffset[3];
...
SEG_PARAM_EXTERN CartesianVector kLeftAnkleExtensorMidPoint;
...
SEG_PARAM_EXTERN CartesianVector kLeftAnkleFlexorMidPoint;
...
SEG_PARAM_EXTERN CartesianVector kRightAnkleExtensorMidPoint;
...
SEG_PARAM_EXTERN CartesianVector kRightAnkleFlexorMidPoint;
...
SEG_PARAM_EXTERN CartesianVector kLeftFootContactPositions[256];

// Right Foot

SEG_PARAM_EXTERN char kRightFootContactName[256];
SEG_PARAM_EXTERN int kRightFootNumContactPoints;
SEG_PARAM_EXTERN CartesianVector kRightFootContactPositions[256];

// -------------------------------------------
// Kinematic Goal Parameters
// -------------------------------------------

SEG_PARAM_EXTERN double kTorsoPositionTarget[7];
SEG_PARAM_EXTERN SpatialVector kTorsoVelocityTarget;
SEG_PARAM_EXTERN double kLeftThighMDHThetaTarget;
SEG_PARAM_EXTERN double kLeftThighMDHThetaVTarget;
SEG_PARAM_EXTERN double kLeftLegMDHThetaTarget;
SEG_PARAM_EXTERN double kLeftLegMDHThetaVTarget;
SEG_PARAM_EXTERN double kLeftFootMDHThetaTarget;
SEG_PARAM_EXTERN double kLeftFootMDHThetaVTarget;
SEG_PARAM_EXTERN double kRightThighMDHThetaTarget;
SEG_PARAM_EXTERN double kRightThighMDHThetaVTarget;
SEG_PARAM_EXTERN double kRightLegMDHThetaTarget;
SEG_PARAM_EXTERN double kRightLegMDHThetaVTarget;
SEG_PARAM_EXTERN double kRightFootMDHThetaTarget;
SEG_PARAM_EXTERN double kRightFootMDHThetaVTarget;

...
// count the number of token to the end of file
int ParameterFile::CountTokensToEOF(bool searchFromStart)
{
  char *p;
  int count = 0;
  bool firstTime = true;
...
// count the number of token to the end of line
int ParameterFile::CountTokensToEOL(bool searchFromStart)
{
  char *p;
  int count = 0;
  bool firstTime = true;
